...
namespace SMLReader
{
    public class ChargerClient
    {
        ...
        public async Task<int> GetCurrentChargingPower()
        {
            ...
            allChargingPhaseTasks[0] = client.GetAsync("getPlainValue/knx.0.Sensorik.Zentral.Wallbox-Leistung_L2");
            allChargingPhaseTasks[0] = client.GetAsync("getPlainValue/knx.0.Sensorik.Zentral.Wallbox-Leistung_L1");
